...
<div class="container p-5">
    <h1>Vous etes une entreprise?</h1>
   <h3>Inscrivez-vous gratuitement</h3>
        <p>   
        Les entreprises peuvent publier une ou plusieurs offres d’emploi et consulter les profils des candidats, en fonction de l’abonnement choisi. Elles sélectionnent les candidats correspondant le mieux aux exigences de leurs offres, leur fixent des rendez-vous d'entretien, puis décident d’un recrutement ou non après l’évaluation. Si aucune des candidatures disponibles ne correspond aux besoins, les entreprises peuvent solliciter des cabinets de recrutement pour des recommandations plus précises. Ce processus de recrutement par cabinet inclut également les entretiens et les retours sur les candidats proposés.
</p>
<a href="{{ route('register')}}" class="btn  btn-round " style="background-color: #035874; color: white;">S'inscrire</a>
