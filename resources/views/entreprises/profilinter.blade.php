...
<div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-user">
              ...
              <div class="card-body">
              <form action="{{ route('entreprises.updateInter' , $entreprise->id) }}" method="POST" enctype="multipart/form-data"> 
                              @csrf
                      @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Nom  </label>
                        <input type="text" class="form-control"  placeholder="Nom" value="{{ $entreprise->user->last_name }}" name="last_name">
                      </div>
                    </div>
                    ...
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  value="{{ $entreprise->user->first_name }}" name="first_name">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  value="{{ $entreprise->user->telephone }}" name="telephone">
                      </div>
                      </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Fonction  </label>
                        <input type="text" class="form-control"  name="fonction" value="{{ $entreprise->fonction }}">
                      </div>
                      </div>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Email</label>
                        <input type="email" class="form-control"  name="email" value="{{ $entreprise->user->email }}">
