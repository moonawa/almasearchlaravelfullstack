            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Expirés</p>
              ...
              <div class="card-footer ">
                ...
                <div class="stats">
                  <i class="fa fa-eye"></i>
                  <a href="{{ route('offreexpireentreprise') }}" style="color: #9A9A9A; text-decoration: none;">Voir</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">S. Recrutés</p> 
                      <p class="card-title">  {{ $recrutes }}<p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"> {{ $proposition }}<p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category"> P. Recrutés</p>
                      <p class="card-title"> {{ $recrutesproposition }}<p>
                    </div>
                  </div>
                </div>
              </div>
