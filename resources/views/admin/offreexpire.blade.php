...
<div class="row">
  ...
  <div class="row p-4" >
    ...
    <div class="col-md-2"> <a href="{{ route('offreexpireadmin') }}" style="  background-color: #325fa6; padding-left: 15px;  padding-right: 15px; padding-top: 5px; padding-bottom: 5px; color:white; border-radius:20px; text-decoration: none;  text-decoration: none;">Expirés</a></div>
