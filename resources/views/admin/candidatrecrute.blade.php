...
<p>L'entreprise a  fait appel aux cabinets</p>
  ...
  <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="{{ route('showoffrerecruteadmin', $offre->id)}}" style="color:#325fa6;">Recrutés ({{$candidatrecrutecount}})</a>
  </li>
  <li class="nav-item">
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tbody>
              ...
              @else
              <tr>
                <td class="text-center" colspan="5">Il n'y a pas encore de Recru</td>
              </tr>
              @endif
            </tbody>
          </table>
