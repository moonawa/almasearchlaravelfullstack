  ...
  <div class="col-md-12">
    <div class="card">
      <div class="row p-4">
        ...
        <div class="col-md-2"><a href="{{ route('competences') }}" style="background-color: #ef882b; color:white; padding-left: 12px; padding-right: 12px; padding-top: 5px; padding-bottom: 5px;  border-radius:20px; text-decoration: none;">Compétences</a> </div>
